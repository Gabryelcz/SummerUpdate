...
public class Modelsnorkels<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "snorkels"), "main");
	private final ModelPart snorkles;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition snorkles = partdefinition.addOrReplaceChild("snorkles", CubeListBuilder.create().texOffs(0, 6)
				.addBox(-1.0F, -2.5F, -5.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.5F, 0.0F));

		PartDefinition cube_r1 = snorkles.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 2).addBox(-1.87F, -0.8F, -0.51F, 6.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 0.0F, -4.5F, 0.0F, 0.0F, -0.1745F));

		PartDefinition cube_r2 = snorkles.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.8F, 0.35F, 0.5F, 8.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.7F, -4.35F, -4.5F, 0.0F, -0.0873F, -1.5708F));

		PartDefinition cube_r3 = snorkles.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 4).addBox(-4.0F, -1.9684F, -0.8609F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
